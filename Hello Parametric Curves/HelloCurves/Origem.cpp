...
//#endif
	...
	//int nbCurvePoints = catmull.getNbCurvePoints();
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		bezier.drawCurve(glm::vec4(0, 0, 1, 1));
		//catmull.drawCurve(glm::vec4(0, 0, 0, 1));

		//glm::vec3 pointOnCurve = catmull.getPointOnCurve(i);
